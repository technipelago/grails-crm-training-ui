...
<head>
    ...
    <title><g:message code="crmTraining.export.title" args="[entityName]"/></title>
    <r:script>
...
<crm:header title="crmTraining.export.title" subtitle="crmTraining.export.subtitle" args="[entityName]"/>
...
<div class="form-actions">
    <select:link action="list" selection="${selection}" class="btn">
        ...
        <g:message code="crmTraining.button.back.label" default="Back"/>
    </select:link>
</div>
